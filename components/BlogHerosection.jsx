  ...
  return (
    <div className="main-container">
        ...
        <div className="flex my-5 gap-5">
            ...
            <div className="">
                <h2 className="label-1_bold text-grnSec mb-4">Popular Blogs this week</h2>
                <div className="flex gap-3 my-5">
                    ...
                    <div>
                        ...
                        <Link href="/blog/1">                    
                            <h1 className="text-1_bold mb-1">Money: Insights, Tips, and Trends</h1>
                        </Link>
        ...
        <h5 className="label-1_bold mb-4"> Finance: Insights, Tips, and Trends</h5>
        <p className="text-1_regular mb-5">
            Transforming Ideas into Digital Realities, Where Vision Meets
            Innovation. Your Partner in Technology Transforming Ideas into Digital Realities, Where  Meets
            Innovation. Your Partner   
        </p>
